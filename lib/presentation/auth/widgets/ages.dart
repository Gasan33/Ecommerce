import 'package:bloc_ecommerce/presentation/auth/bloc/age_selection_cubit.dart';
import 'package:bloc_ecommerce/presentation/auth/bloc/ages_display_cubit.dart';
import 'package:bloc_ecommerce/presentation/auth/bloc/ages_display_states.dart';
    ...
    return ListView.separated(
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            ...
            child: Text(ages[index].data()['value'],style: const TextStyle(
              fontSize: 18
            ),),
          );
        },
